...
export default function HomePage() {
  ...
  return (
    <main className={`min-h-screen relative overflow-hidden font-sans selection:bg-primary/30 ${userInfo ? 'bg-black text-white' : 'bg-background'}`}>
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 py-8 min-h-screen flex flex-col">
        ...
        <header className="flex justify-between items-center mb-8 md:mb-16 h-20 shrink-0">
           ...
           {userInfo ? (
            <div className="hidden md:flex flex-col items-end">
                <span className="text-xs text-muted-foreground mb-1 mr-1">check it out in</span>
                <a
             ...
             {userInfo ? (
                ...
                <>
                   <div className="space-y-2">
                     <motion.div variants={itemVariants} className="flex items-center gap-3 text-2xl md:text-3xl font-light text-gray-300">
                        <span>Welcome Back to</span>
                        <Image src="/inline_logo.svg" alt="coil" width={60} height={20} className="opacity-80" />
                     </motion.div>
                     <motion.h1 variants={itemVariants} className={`${userInfo.username.length > 10 ? 'text-3xl md:text-4xl lg:text-5xl' : 'text-5xl md:text-6xl lg:text-7xl'} font-bold text-white tracking-tight`}>
                        {userInfo.username}
                     </motion.h1>
                   </div>

                   <motion.p variants={itemVariants} className="text-xl text-gray-400 font-light">
                ...
                <>
                  ...
                  <motion.div variants={itemVariants} className="text-lg md:text-xl text-white space-y-2">
                    <p className="flex items-center flex-wrap gap-2">
                      ...
                      <Glimpse>
                        <GlimpseTrigger asChild>
                          ...
                          >
                            <span>Next.js</span>
                            <Image src="/nextjs-icon.svg" alt="Next.js" width={28} height={28} className="w-7 h-7 align-middle" />
                          </a>
                        </GlimpseTrigger>
                        <GlimpseContent>
                      ...
                      <Glimpse>
                        <GlimpseTrigger asChild>
                          ...
                          >
                            <span>Yjs</span>
                            <Image src="/yjs-icon.svg" alt="Yjs" width={28} height={28} className="w-7 h-7 align-middle" />
                          </a>
                        </GlimpseTrigger>
                        <GlimpseContent>
                      ...
                      <span className="text-muted-foreground text-sm">(synchronization)</span>,{" "}
                      <Glimpse>
                        <GlimpseTrigger asChild>
                          <a
                          ...
                          >
                            <span>PartyKit</span>
                            <Image src="/partykit-icon.svg" alt="PartyKit" width={28} height={28} className="w-7 h-7 align-middle" />
                          </a>
                        </GlimpseTrigger>
                        <GlimpseContent>
                      ...
                      <span className="text-muted-foreground text-sm">(backend)</span>, and it is -{" "}
                      <Glimpse>
                        <GlimpseTrigger asChild>
                        ...
                        <GlimpseContent>
                          ...
                          <GlimpseTitle>Monaco Editor - VS Code Editor</GlimpseTitle>
                          <GlimpseDescription>
                 ...
                 <motion.div variants={itemVariants} className="flex flex-col items-center gap-8 -mt-12">
        ...
        <footer className="shrink-0 h-20 flex flex-col md:flex-row justify-between items-center pb-8 mt-auto">
           <p className={`${userInfo ? 'text-gray-500' : 'text-foreground'} text-sm`}>
              © 2025 Coil Code by AA³. All rights reserved
           </p>

           <div className="flex items-center gap-6 mt-4 md:mt-0">
                <a href="https://github.com/MRQ67" className="opacity-60 hover:opacity-100 transition-opacity">
                  <Image src="/soical_icons/github-142-svgrepo-com.svg" alt="GitHub" width={24} height={24} className="w-6 h-6 invert" />
                </a>
                <a href="https://x.com/HimoNotting" className="opacity-60 hover:opacity-100 transition-opacity">
                  <Image src="/soical_icons/X_logo_2023_original.svg" alt="X" width={24} height={24} className="w-6 h-6 invert" />
                </a>
                <a href="https://www.linkedin.com/in/abdellah-qadi-b229382a2/" className="opacity-60 hover:opacity-100 transition-opacity">
                  <Image src="/soical_icons/linkedin-svgrepo-com.svg" alt="LinkedIn" width={24} height={24} className="w-6 h-6 invert" />
                </a>
                <a href="https://www.instagram.com/simply_aboo/" className="opacity-60 hover:opacity-100 transition-opacity">
                  <Image src="/soical_icons/instagram-167-svgrepo-com.svg" alt="Instagram" width={24} height={24} className="w-6 h-6 invert" />
                </a>
           </div>
        </footer>
        ...
        <DialogContent className="sm:max-w-[425px] bg-[#1A1A1A] border-white/10 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Are you sure you want to sign out? Your username and avatar preferences will be cleared from this device.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="ghost" onClick={() => setIsSignOutDialogOpen(false)} className="text-white hover:bg-white/10 hover:text-white">
              Cancel
            </Button>
